...
- Focused Note Pin turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a focused note pin web app with local persistence, visible actions, and app-state evidence.
...
- Record Operations - Focused Note Pin
- Record Editor - Focused Note Pin
- Insights - Focused Note Pin

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - Focused Note Pin
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - Focused Note Pin
...
SCREEN_SPEC_3:
- exact_screen_title: Insights - Focused Note Pin
